...
| OPENID4VC_PUBLIC_BASE_URL                   | N        | ""                                                                                                                                                                                                      | Public base URL used by OpenID4VC. Development default: `http://localhost:5004`.                                                 |
| OPENID4VC_ID                                | N        | ""                                                                                                                                                                                                      | Public issuer and verifier resource identifier. Development default: `alice`.                                                     |
| OPENID4VC_PORT                              | N        | 5004                                                                                                                                                                                                    | Port to bind the dedicated OpenID4VC listener.                                                                                    |

OpenID4VC is considered enabled when at least one role flag is true (`OPENID4VC_HOLDER_ENABLED`, `OPENID4VC_ISSUER_ENABLED`, or `OPENID4VC_VERIFIER_ENABLED`).
