...
export class CredentialController extends Controller {
  ...
  public async getCredentialById(
    ...
    try {
      ...
      req.log.error(`error occurred in GET /credentials/:credentialRecordId ${error}`)
      throw error
    }
  }
  ...
  public async getCredentialFormatDataById(
    ...
    try {
      ...
      req.log.error(`error occurred in GET /credentials/:credentialRecordId/format-data ${error}`)
      throw error
    }
  }
  ...
  public async deleteCredential(
    ...
    try {
      ...
      req.log.error(`error occurred in DELETE /credentials/:credentialRecordId ${error}`)
      throw error
    }
  }
  ...
  public async proposeCredential(@Request() req: express.Request, @Body() options: ProposeCredentialOptions) {
    try {
      ...
      req.log.error(`error occurred in POST /credentials/propose-credential ${error}`)
      throw error
    }
  }
  ...
  public async acceptProposal(
    ...
    try {
      ...
      req.log.error(`error occurred in POST /credentials/:credentialRecordId/accept-proposal ${error}`)
      throw error
    }
  }
  ...
  public async offerCredential(@Request() req: express.Request, @Body() options: OfferCredentialOptions) {
    try {
      ...
      req.log.error(`error occurred in POST /credentials/offer-credential ${error}`)
      throw error
    }
  }
  ...
  public async acceptOffer(
    ...
    try {
      ...
      req.log.error(`error occurred in POST /credentials/:credentialRecordId/accept-offer ${error}`)
      throw error
    }
  }
  ...
  public async acceptRequest(
    ...
    try {
      ...
      req.log.error(`error occurred in POST /credentials/:credentialRecordId/accept-request ${error}`)
      throw error
    }
  }
  ...
  public async acceptCredential(
    ...
    try {
      ...
      req.log.error(`error occurred in POST /credentials/:credentialRecordId/accept-credential ${error}`)
      throw error
    }
  }
  ...
  public async sendProblemReport(
    ...
    try {
      ...
      req.log.error(`error occurred in POST /credentials/:credentialRecordId/send-problem-report ${error}`)
      throw error
    }
  }
}
